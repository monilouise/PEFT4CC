...
def compute_metrics(eval_pred):
    pred_label, true_label = eval_pred
...
def train_modernbert(args, train_dataset, eval_dataset, mymodel, tokenizer):
    warmup_ratio=0.05
...
def main(args):
    ...
    if args.do_train:
        ...
        if args.pretrained_model in ['modernbert', 'modernbert-large']:
            train_modernbert(args, train_dataset, eval_dataset, mymodel, tokenizer)
        else:
